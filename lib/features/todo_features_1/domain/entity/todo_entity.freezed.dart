...
abstract class $TodoEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String tittle, bool isChecked});
}
...
class _$TodoEntityImpl implements _TodoEntity {
  _$TodoEntityImpl(
      {required this.id, required this.tittle, required this.isChecked});
  ...
  @override
  String toString() {
    return 'TodoEntity(id: $id, tittle: $tittle, isChecked: $isChecked)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, tittle, isChecked);
